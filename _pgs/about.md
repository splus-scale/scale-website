...
### The Survey
--------------
The Southern Photometric Local Universe Survey (S-PLUS) {% cite splus %} is observing over 9,000 square degrees of the southern sky with the 0.8 m T80-South telescope at Cerro Tololo Inter-American Observatory (CTIO) in Chile. With sharp 0.55 arcsec/pixel resolution and typical depths of 20-21 AB mag, its 12-band Javalambre filter system {% cite jplus %} captures both broad and narrow spectral features, offering a unique window into the physical processes shaping galaxies across cosmic time.
